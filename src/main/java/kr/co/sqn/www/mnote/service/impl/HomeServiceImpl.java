...
import kr.co.sqn.www.mnote.mapper.HomeMapper;
...
public class HomeServiceImpl extends EgovAbstractServiceImpl implements HomeService {
	 ...
	 */
	@Override
	public List<?> selectHomeList(HomeVO homeVO) throws Exception {
		return homeDAO.selectHomeList(homeVO);
	}
	 ...
	 */
	@Override
	public int selectHomeListTotCnt(HomeVO homeVO) {
		return homeDAO.selectHomeListTotCnt(homeVO);
	}
